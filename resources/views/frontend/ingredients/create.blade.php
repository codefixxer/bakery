...
@section('content')
    <div class="container py-5">
        <div class="card border-success shadow-sm">
            <div class="card-header" style="background-color: #041930; color: #e2ae76;" class="d-flex align-items-center">
              <!-- Adjusted Icon with gold color and updated size -->
              <svg height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 512 512" xml:space="preserve" style="fill: #e2ae76; margin-right: 10px;">
                ...
                <h5 class="mb-0" style="color: #e2ae76;">Add Ingredient</h5>
            </div>
            <div class="card-body">
                <form
