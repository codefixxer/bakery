...
<div class="container py-5 px-md-5">
  <div class="card border-primary shadow-sm rounded-3 overflow-hidden">
    ...
    <div class="card-header d-flex align-items-center" style="background-color: #041930;">
      ...
      <h5 class="mb-0 fw-bold" style="color: #e2ae76;">Chef — {{ $pastryChef->name }}</h5>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="d-flex justify-content-end gap-2">
        ...
        <form action="{{ route('pastry-chefs.destroy', $pastryChef) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this chef?');">
          @csrf
          @method('DELETE')
