...
<div class="container py-5">
  <div class="card border-primary shadow-lg rounded-3 overflow-hidden">
    ...
    <div class="card-header bg-primary text-white d-flex align-items-center">
      <iconify-icon icon="lucide:list" class="fs-2 me-3"></iconify-icon>
      <h4 class="mb-0">{{ $costCategory->name }}</h4>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4 mb-4">
        ...
        <div class="col">
          ...
          <p class="fs-5 mb-0">{{ $costCategory->id }}</p>
        </div>
        <div class="col">
          <h6 class="text-uppercase text-muted small mb-1">Created At</h6>
          <p class="fs-5 mb-0">
            {{ optional($costCategory->created_at)->format('Y-m-d H:i') ?? '—' }}
          </p>
        </div>
        <div class="col">
          <h6 class="text-uppercase text-muted small mb-1">Last Updated</h6>
          <p class="fs-5 mb-0">
            {{ optional($costCategory->updated_at)->format('Y-m-d H:i') ?? '—' }}
          </p>
        </div>
      </div>
