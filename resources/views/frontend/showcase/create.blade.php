  ...
  <div class="container py-5">
    <div class="card border-primary shadow-sm mb-4">
      <div class="card-header d-flex align-items-center" style="background-color: #041930;">
        ...
        <h4 class="mb-0 fw-bold" style="color: #e2ae76;">{{ $isEdit ? 'Edit Daily Showcase' : 'Create Daily Showcase' }}</h4>
      </div>
      <div class="card-body">
        <form method="POST"
                  ...
                  @for($i = 0; $i < $rowCount; $i++)
                    ...
                    <tr class="showcase-row">
                      <td>
                        ...
                        <input type="hidden" name="items[{{ $i }}][department_id]" class="dept-id-field" value="{{ old("items.$i.department_id", optional($item->recipe->department ?? null)->id) }}">
                      </td>
                      ...
                      <td><input type="number" name="items[{{ $i }}][quantity]" class="form-control form-control-sm text-center qty-field" style="max-width: 80px;" value="{{ old("items.$i.quantity", $item->quantity ?? 0) }}" required></td>
                      <td><input type="number" name="items[{{ $i }}][sold]" class="form-control form-control-sm text-center sold-field" style="max-width: 80px;" value="{{ old("items.$i.sold", $item->sold ?? 0) }}" required></td>
                      <td><input type="number" name="items[{{ $i }}][reuse]" class="form-control form-control-sm text-center reuse-field" style="max-width: 80px;" value="{{ old("items.$i.reuse", $item->reuse ?? 0) }}" required></td>
                      <td><input type="number" name="items[{{ $i }}][waste]" class="form-control form-control-sm text-center waste-field" style="max-width: 80px;" value="{{ old("items.$i.waste", $item->waste ?? 0) }}" required></td>
                      <td>
                        <div class="input-group input-group-sm">
                          <span class="input-group-text">€</span>
          ...
          <div class="d-flex align-items-end justify-content-between flex-wrap mb-4 gap-3">
            <div class="d-flex flex-column">
              ...
              <input type="number" id="break_even" class="form-control form-control-sm" style="width: 140px;" 
                     value="{{ old('break_even', $isEdit ? $showcase->break_even : ($laborCost->daily_bep ?? 0)) }}" disabled>
            </div>
          
            <div class="d-flex flex-column">
              <label class="form-label fw-semibold">Total Revenue (€)</label>
              <input type="text" id="totalRevenue" class="form-control form-control-sm" style="width: 140px;" readonly>
            </div>
          
            <div class="d-flex flex-column">
              <label class="form-label fw-semibold">Plus (€)</label>
              <input type="text" id="plusAmount" class="form-control form-control-sm" style="width: 140px;" readonly>
              {{-- <div class="form-text fm-plus-pct"></div> --}}
            </div>
          
            <div class="d-flex flex-column">
              <label class="form-label fw-semibold">Total Potential (€)</label>
              <input type="text" id="totalPotential" class="form-control form-control-sm" style="width: 140px;" readonly>
            </div>
          
            <div class="d-flex flex-column">
              <label class="form-label fw-semibold">Real Margin (€)</label>
              <input type="text" id="realMargin" class="form-control form-control-sm" style="width: 140px;" readonly>
