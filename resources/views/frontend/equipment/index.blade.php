    ...
    <div class="container py-5">
                ...
                <form action="{{ route('equipment.store') }}" method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" id="Name" name="name" class="form-control form-control-lg"
                            placeholder="e.g. Mixer, Oven" required value="{{ old('name') }}">
        ...
        <div class="card border-primary shadow-sm">
            ...
            <div class="card-body table-responsive">
                <table id="equipmentTable" class="table table-striped table-hover table-bordered align-middle mb-0"
                    data-page-length="10">
                        ...
                        @forelse($equipments as $equ)
                            <tr>
                                ...
                                <td class="text-center">
                                    <!-- View Button -->
                                    <a href="{{ route('equipment.show', $equ) }}" class="btn btn-sm btn-outline-info me-1"
                                        title="View Equipment">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <!-- Edit Button -->
                                    <a href="{{ route('equipment.edit', $equ) }}"
                                        class="btn btn-sm btn-outline-primary me-1" title="Edit Equipment">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <!-- Delete Button -->
                                    <form action="{{ route('equipment.destroy', $equ) }}" method="POST" class="d-inline"
