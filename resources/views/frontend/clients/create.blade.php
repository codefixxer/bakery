...
<div class="container py-5 px-md-5">
  <div class="card border-primary shadow-sm">
    ...
    <div class="card-body">
      <form action="{{ isset($client) ? route('clients.update', $client->id) : route('clients.store') }}" method="POST" class="row g-4 needs-validation" novalidate>
        @csrf
        @if(isset($client))
          @method('PUT')
        @endif
        ...
        <div class="col-md-4">
          ...
          <input type="text" name="notes" id="notes" class="form-control form-control-lg"
