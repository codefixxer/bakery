                        ...
                        <tbody>
                            @foreach ($recipes as $r)
                                @php
                                    ...
                                    $ingredientsData = $r->ingredients->map(
                                        fn($ri) => [
                                            'name' => $ri->ingredient->ingredient_name,
                                            'qty_g' => $ri->quantity_g,
                                            'cost' => round(
                                                ($ri->quantity_g / 1000) * $ri->ingredient->price_per_kg,
                                                2,
                                            ),
                                        ],
                                    );
                                ...
                                <tr class="dt-control" data-ingredients='@json($ingredientsData)'>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('recipes.edit', $r->id) }}" class="btn btn-sm me-1"
                                        ...
                                        <a href="{{ route('recipes.show', $r->id) }}" class="btn btn-sm me-1"
                                        ...
                                        <form action="{{ route('recipes.destroy', $r->id) }}" method="POST"
